...
class Aplication:
    ...
    def buttonFirstWindow(self):
        self.btSnake = Button(self.frame2, text='Snake', background='#3a3b3c')
        self.btSnake.place(relx=0.03, rely=0.03, relwidth=0.45, relheight=0.45)

        self.btCampoMinado = Button(self.frame2, text='Campo Minado', background='#3a3b3c')
        self.btCampoMinado.place(relx=0.52, rely=0.03, relwidth=0.45, relheight=0.45)

        self.btCorrida = Button(self.frame2, text='Corrida', background='#3a3b3c')
        self.btCorrida.place(relx=0.03, rely=0.52, relwidth=0.45, relheight=0.45)

        self.btForca = Button(self.frame2, text='Forca', background='#3a3b3c')
        self.btForca.place(relx=0.52, rely=0.52, relwidth=0.45, relheight=0.45)

    def labelFirstWindow(self):
        self.lbLogo = Label(self.frame1, text='ebony', font='abnes', background='#3a3b3c')
        self.lbLogo.place(relx=0.01, rely=0.2)
        self.lbLogo1 = Label(self.frame1, text='sys', font='Debum 24', background='#3a3b3c')
